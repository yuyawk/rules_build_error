...
bazel() {
    ...
    # Pass through some environment variables necessary for bazelisk to work properly, if they are defined in the environment
    ...
    # Set BAZEL_VC if defined in the environment
    # https://bazel.build/configure/windows#build_cpp
    [[ -n "${BAZEL_VC:-}" ]] && environment_variables_to_set+=("BAZEL_VC=${BAZEL_VC}")
