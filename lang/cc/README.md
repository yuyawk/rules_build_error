...
| use_default_shell_env    | Determines whether the created actions use the default shell environment during source builds. The behavior is equivalent to the corresponding parameters in `ctx.actions` functions. | bool                                     | No (defaults to `False`)    |                                                                            |
